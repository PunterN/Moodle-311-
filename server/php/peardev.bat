...
FOR %%x IN ("C:\MoodleWindowsInstaller-latest-311\server\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\MoodleWindowsInstaller-latest-311\server\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\MoodleWindowsInstaller-latest-311\server\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\MoodleWindowsInstaller-latest-311\server\php\php.exe"
GOTO :INSTALLED
